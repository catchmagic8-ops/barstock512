...
export default function Departments() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col">
      ...
      <header className="app-header sticky top-0 z-20 flex items-center justify-between bg-background/40 px-5 py-4 backdrop-blur-xl backdrop-saturate-150 sm:px-8">
